...
def resnet18(num_classes=1000):
    ...
    return ResNet(firstlayer, BasicBlock, [2, 2, 2, 2], num_classes=num_classes)


def resnet18_Garbor(num_classes=1000):
    firstlayer = Gab(out_channl=48, in_channl=1, kernal_size=11)
    return ResNet(firstlayer, BasicBlock, [2, 2, 2, 2], num_classes=num_classes)


def resnet18_SCHMID(num_classes=1000):
    firstlayer = SCHMID(out_channl=48, in_channl=1, kernal_size=11)
    return ResNet(firstlayer, BasicBlock, [2, 2, 2, 2], num_classes=num_classes)


def resnet18_LM(num_classes=1000):
    firstlayer = lm()
    return ResNet(firstlayer, BasicBlock, [2, 2, 2, 2], num_classes=num_classes)


if __name__ == '__main__':
    a = resnet18_LM(num_classes=5).cuda()
